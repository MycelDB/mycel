...
- [Clustered automation execution implementation plan](clustered-automation-execution-implementation-plan.md) — phased plan for single-pod, partition-leader-owned automation execution with deterministic invocation IDs, Raft-owned execution state, claims, fencing, failover reconciliation, and scheduled automation safety.
