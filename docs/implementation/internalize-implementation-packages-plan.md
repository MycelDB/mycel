...
- Add documentation in README and `docs/design/daemon-only-boundary.md`.
...
6. `Document daemon-only Go package boundary` — implemented in README, `doc.go`, historical v1 notes, and `docs/design/daemon-only-boundary.md`.
