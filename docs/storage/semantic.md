...
- When nodes move into or out of restricted subtrees, graph commits record old/new containment context and semantic analysis later decides refresh, skip, tombstone, or deletion behavior.
