...
- `v2/` contains the daemon-oriented design and API documentation, including the semantic/embedding package design in `v2/design/embedding-package.md` and implementation plan in `v2/design/embedding-generation-implementation-plan.md`.
