...
```text
docs/v2/design/clustering-membership-admission.md
```
...
```text
docs/v2/design/clustering-membership-admission.md
docs/v2/design/clustering-subsystem-architecture.md
docs/v2/design/clustering-subsystem-implementation-plan.md
```
