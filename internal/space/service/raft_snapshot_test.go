...
func TestSpaceRaftStateMachineSnapshotRestorePartition(t *testing.T) {
	...
	_, createCmd, err := m.buildCreateSpaceRaftCommand(CreateSpaceInput{Name: "snapshot-space", OwnerPrincipalID: ownerID, DefaultDomainKey: "notes", DefaultDomainName: "Notes"}, 4, "create-space-snapshot")
	if err != nil {
