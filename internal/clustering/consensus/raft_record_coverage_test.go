...
var phaseDRaftRecordCoverage = map[string]raftRecordCoverage{
	...
	"space.delete.v1":                     {Subsystem: "space", Scope: "partition raft", Status: "gap", Tranche: "D1"},
	...
	"schema.put.v1":                       {Subsystem: "schema", Scope: "partition raft", Status: "gap", Tranche: "D2"},
	"schema.delete.v1":                    {Subsystem: "schema", Scope: "partition raft", Status: "gap", Tranche: "D2"},
	"semantic.global.mutation.v1":         {Subsystem: "semantic", Scope: "system raft or fail-closed", Status: "gap", Tranche: "D4"},
	...
	"semantic.accounting.mutation.v1":     {Subsystem: "semantic accounting", Scope: "system raft, partition raft, derived, or fail-closed", Status: "gap", Tranche: "D4"},
	"embedding.provider_key.put.v1":       {Subsystem: "embedding", Scope: "system raft or semantic global", Status: "gap", Tranche: "D4"},
	"embedding.provider_key.delete.v1":    {Subsystem: "embedding", Scope: "system raft or semantic global", Status: "gap", Tranche: "D4"},
