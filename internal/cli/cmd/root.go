...
func NewRootCommand(a *app.App, repl bool) *cobra.Command {
	...
	root.AddCommand(NewInitCommand(a), NewAddCommand(a), NewGetCommand(a), NewDeleteCommand(a), NewListCommand(a), NewACLCommand(a), NewEmbeddingsCommand(a), NewReplCommand(a))
	if repl {
		root.Use = ""
	}
	return root
