...
func NewRootCommand(a *app.App, repl bool) *cobra.Command {
	...
	root.AddCommand(NewPrincipalCommand(a), NewAdminCommand(a), NewUserCommand(a), NewSpaceCommand(a), NewDomainCommand(a), NewNodeCommand(a), NewGraphCommand(a), NewBlobCommand(a), NewAuthCommand(a), NewSessionCommand(a), NewTransactionCommand(a), NewQueryCommand(a), NewSearchCommand(a), NewSchemaCommand(a), NewAutomationCommand(a), NewProcedureCommand(a), NewAutomationBindingCommand(a), NewMetadataCommand(a), NewExportCommand(a), NewImportCommand(a), NewInferenceCommand(a), NewSemanticCommand(a), NewChangeStreamCommand(a), NewClusterCommand(a), NewReplCommand(a))
	if repl {
		root.Use = ""
	}
	return root
